...
1. Complete the assigned readings
    * McElreath ch 6
2. Review the resources (slides and [notes][20])
...
[20]: docs/08-causal-inference.html
...
```{=html}
<iframe class="slide-deck" src="slides/causal_inference.html" width="525" height="350"></iframe>
```

</div>

[Link to HTML slides](/slides/causal_inference.qmd){target="_blank"}
...
1. Complete the assigned readings
    * McElreath ch 9
2. Review the resources (slides and [notes][21])
3. Attend the Tuesday and Thursday class meetings
4. Complete Homework 6 (see instruction on Brightspace)

[21]: docs/09-mcmc.html
...
```{=html}
<iframe class="slide-deck" src="slides/mcmc.html" width="525" height="350"></iframe>
```

</div>

[Link to HTML slides](/slides/mcmc.qmd){target="_blank"}
...
1. Complete the assigned readings
    * McElreath ch 10, 11
2. Review the resources (slides and [notes][22])
3. Attend the Tuesday and Thursday class meetings
...
```{=html}
<iframe class="slide-deck" src="slides/glm.html" width="525" height="350"></iframe>
```

</div>

[Link to HTML slides](/slides/glm.qmd){target="_blank"}
...
[Link to HTML slides](/slides/mlm.qmd){target="_blank"}
