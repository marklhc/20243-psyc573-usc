...
Welcome to PSYC 573! USC is making a change in our online learning platform, and we are now using Brightspace. 

### How to Log In

To access Brightspace today, follow these steps:
1. Go to <https://brightspace.usc.edu/d2l/login> to login. You can also find Brightspace on myUSC. 
2. Enter your USC Net ID to access 
3. Begin navigating through Brightspace

USC also encourages students to download the mobile app, Brightspace Pulse, available in both the [Apple App Store](https://apps.apple.com/us/app/brightspace-pulse/id1001688546?ls=1) and [Google Play](https://play.google.com/store/apps/details?id=com.d2l.brightspace.student.android&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1&pli=1).

### What to Expect

Brightspace provides an enhanced learning experience with detailed class progress reports. With Brightspace, you can easily see all assignment due dates in one place. Upon opening Brightspace, you will find the following:  

- The 20243 PSYC-573: Bayesian Data Analysis Course: We will use this course to complete work for this course throughout the semester.

### Support Resources

Do you want to learn more about Brightspace? Check out training and resources in the [Brightspace Student Tutorials](https://www.youtube.com/watch?v=YyUKfhc_klE&list=PLxHabmZzFY6k04NnOD0XJqWwJWcesCN12). Find technical support information below:

- Student Guides: Brightspace Student Guides
- Brightspace Technical Support Line: 888-895-2812
- Brightspace Email Support: usc@d2l.com
...
- [R](https://cloud.r-project.org/) and [RStudio](https://rstudio.com/products/rstudio/download/) are needed to complete the course assignments. It is highly recommended that students update to the latest versions of both software (R 4.4.0, RStudio 2024.04.1, or above). We will briefly discuss setting up R and RStudio in Week 1.
...
| Oct 8 & ~~10~~  | Monte Carlo           |                              | - HW 6               |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 8\         | - Generalized Linear  | - McElreath ch. 10           | - Exercise 8         |
| Oct 15 & 17     | model (GLM) I         |                              | - HW 7               |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 9\         | - GLM II              | - McElreath ch. 11           | - Exercise 9         |
| Oct 22 & 24     |                       |                              | - Project prospectus |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 10\        | - Multilevel Models   | - McElreath ch. 13,          |                      |
| Oct 29 & 31     |                       | 14.1, 14.2                   |                      |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 11\        | - Missing data        | - McElreath ch. 15           | - Exercise 10        |
| Nov 5 & 7       | - Measurement error   |                              | - HW 8               |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 12\        | - Latent variable     | - Supplemental reading       | - Exercise 11        |
| Nov 12 & 14     | models                | - McElreath ch. 5, 6         | - HW 9               |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 13\        | - Social networks     | - McElreath ch. 7            | - Exercise 12        |
| Nov 19 & 21     |                       | - [Broda et al. (2023)][9]   | - HW 10              |
|                 |                       | Kruschke ch. 10              |                      |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 14\        | - Advanced topic      | - McElreath ch. 15           | - Exercise:          |
| Nov 26 & ~~28~~ |                       |                              | - HW 11              |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 15\        | - Presentation        | - Kruschke ch. 21--24        | - HW 12              |
| Dec 2 & 4       |                       | (pick topic of interest)     | - Project update     |
|                 |                       | - Kruschke ch. 25            |                      |
+-----------------+-----------------------+------------------------------+----------------------+
| FINAL           | Final report          |                              | Dec 12 1:00 pm PST   |
+-----------------+-----------------------+------------------------------+----------------------+
