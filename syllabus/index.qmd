...
|                 |                       | [James ch. 1][3]             |                      |
+-----------------+-----------------------+------------------------------+----------------------+
| Week 3\         | - One-parameter Model | - [Johnson ch. 3][6]         | - Exercise 3         |
| Sep 10 & 12     | for binary variables  | - [Getting started wit       |                      |
|                 | - Bayesian workflow   | CmdStanR][10]                |                      |
|                 | - Stan                |                              |                      |
+-----------------+-----------------------+------------------------------+----------------------+
